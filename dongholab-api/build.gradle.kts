...
tasks {
    withType<BootJar> {
        mainClass.set("com.dongholab.api.DongholabApiApplicationKt")
    }
}
...
dependencies {
    ...
    testImplementation(testFixtures(project(":dongholab-domain")))
    testImplementation("org.springframework.boot:spring-boot-starter-test")
}

tasks.withType<GenerateJavaTask> {
    schemaPaths = mutableListOf("${projectDir}/src/main/resources/dongholab.graphqls")
    packageName = "com.dongholab.api.generated"
