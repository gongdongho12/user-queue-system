...
@Configuration
class DefaultKafkaConfiguration {
    @Bean
    fun defaultKafkaTemplate(@Value("\${kafka.dongholab.bootstrap-servers}") brokers: String): KafkaTemplate<String, String> {
    ...
    @Bean
    fun kafkaAdminClient(@Value("\${kafka.dongholab.bootstrap-servers}") brokers: String): AdminClient =
